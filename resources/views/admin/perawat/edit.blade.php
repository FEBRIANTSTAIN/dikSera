                ...
                <div class="col-md-auto" style="min-width: 180px;">
                    <div class="profile-img-box mb-3">
                        ...
                        @else
                            ...
                            <img src="" alt="Preview" id="preview-foto" class="d-none" style="width:100%; height:100%; object-fit:cover;">
                        @endif
                    </div>
                    
                    <input type="file" class="d-none" id="foto_3x4" name="foto_3x4" onchange="previewImage(this)">
                    <label for="foto_3x4" class="btn btn-sm btn-outline-primary w-100 d-flex align-items-center justify-content-center gap-2">
                        ...
                        <div class="col-md-4">
                            <div class="row g-2">
                                <div class="col-4">
                                    ...
                                    <input type="number" class="form-control px-2 text-center" name="tinggi_badan" value="{{ old('tinggi_badan', $profile->tinggi_badan ?? '') }}">
                                </div>
                                <div class="col-4">
                                    <label class="form-label small text-muted">BB (kg)</label>
                                    <input type="number" class="form-control px-2 text-center" name="berat_badan" value="{{ old('berat_badan', $profile->berat_badan ?? '') }}">
                                </div>
                                <div class="col-4">
                                    ...
                                    <select class="form-select px-1 text-center" name="golongan_darah">
                                        ...
                                        @foreach (['A', 'B', 'AB', 'O'] as $goldar)
                                            <option value="{{ $goldar }}" {{ old('golongan_darah', $profile->golongan_darah ?? '') == $goldar ? 'selected' : '' }}>{{ $goldar }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                @foreach ($pendidikan as $i => $row)
                    <div class="row g-2 mb-3 align-items-end pendidikan-row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="pendidikan[{{ $i }}][jenjang]" value="{{ $row->jenjang }}" placeholder="D3/S1">
                        </div>
                        <div class="col-md-5">
                            <label class="small text-muted mb-1">Nama Institusi</label>
                            <input type="text" class="form-control" name="pendidikan[{{ $i }}][nama_institusi]" value="{{ $row->nama_institusi }}">
                        </div>
                        <div class="col-md-3">
                            <label class="small text-muted mb-1">Tahun Lulus</label>
                            <input type="text" class="form-control" name="pendidikan[{{ $i }}][tahun_lulus]" value="{{ $row->tahun_lulus }}">
                        </div>
                        <div class="col-md-1">
                ...
                @foreach ($pelatihan as $i => $row)
                    <div class="row g-2 mb-3 align-items-end pelatihan-row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="pelatihan[{{ $i }}][nama_pelatihan]" value="{{ $row->nama_pelatihan }}">
                        </div>
                        <div class="col-md-4">
                            <label class="small text-muted mb-1">Penyelenggara</label>
                            <input type="text" class="form-control" name="pelatihan[{{ $i }}][penyelenggara]" value="{{ $row->penyelenggara }}">
                        </div>
                        <div class="col-md-3">
                            <label class="small text-muted mb-1">Tahun</label>
                            <input type="text" class="form-control" name="pelatihan[{{ $i }}][tanggal_mulai]" value="{{ $row->tanggal_mulai }}">
                        </div>
                        <div class="col-md-1">
                            <label class="small text-muted mb-1 d-block">&nbsp;</label>
                            <button type="button" class="btn btn-outline-danger w-100" onclick="removeRow(this)"><i class="bi bi-trash"></i></button>
                ...
                @foreach ($pekerjaan as $i => $row)
                    <div class="row g-2 mb-3 align-items-end pekerjaan-row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="pekerjaan[{{ $i }}][nama_instansi]" value="{{ $row->nama_instansi }}">
                        </div>
                        <div class="col-md-3">
                            <label class="small text-muted mb-1">Jabatan</label>
                            <input type="text" class="form-control" name="pekerjaan[{{ $i }}][jabatan]" value="{{ $row->jabatan }}">
                        </div>
                        <div class="col-md-2">
                            <label class="small text-muted mb-1">Mulai</label>
                            <input type="text" class="form-control" name="pekerjaan[{{ $i }}][tahun_mulai]" value="{{ $row->tahun_mulai }}">
                        </div>
                        <div class="col-md-3">
                            <label class="small text-muted mb-1">Selesai</label>
                            <input type="text" class="form-control" name="pekerjaan[{{ $i }}][tahun_selesai]" value="{{ $row->tahun_selesai }}">
                        </div>
                        <div class="col-md-1">
                            <label class="small text-muted mb-1 d-block">&nbsp;</label>
                            <button type="button" class="btn btn-outline-danger w-100" onclick="removeRow(this)"><i class="bi bi-trash"></i></button>
                ...
                @foreach ($organisasi as $i => $row)
                    <div class="row g-2 mb-3 align-items-end organisasi-row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="organisasi[{{ $i }}][nama_organisasi]" value="{{ $row->nama_organisasi }}">
                        </div>
                        <div class="col-md-4">
                            <label class="small text-muted mb-1">Jabatan</label>
                            <input type="text" class="form-control" name="organisasi[{{ $i }}][jabatan]" value="{{ $row->jabatan }}">
                        </div>
                        <div class="col-md-3">
                            <label class="small text-muted mb-1">Periode</label>
                            <input type="text" class="form-control" name="organisasi[{{ $i }}][tahun_mulai]" value="{{ $row->tahun_mulai }}">
                        </div>
                        <div class="col-md-1">
                            <label class="small text-muted mb-1 d-block">&nbsp;</label>
                            <button type="button" class="btn btn-outline-danger w-100" onclick="removeRow(this)"><i class="bi bi-trash"></i></button>
