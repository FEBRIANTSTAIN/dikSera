...
<head>
    ...
    <style>
        ...
        .container-content {
            ...
            /* --- PERBAIKAN UTAMA: PADDING KANAN 70px --- */
            /* Ini memaksa konten geser ke kiri, menjauhi tepi kertas agar tidak kepotong */
        ...
        /* Ukuran font dibesarkan drastis sesuai permintaan */
        .font-xl { font-size: 36pt; } /* Besar Sekali (misal: PK 1) */
        .font-lg { font-size: 26pt; } /* Besar (misal: PK 1, PK 2) */
        .font-md { font-size: 18pt; } /* Sedang */
        .font-sm { font-size: 14pt; } /* Kecil (hanya jika teks sangat panjang) */
        ...
        .header-left-cell {
            ...
            width: 50%; /* Bagi 2 rata agar seimbang */
        }
        ...
        /* --- KOTAK NOMOR SERTIFIKAT --- */
        .cert-number-box {
            display: inline-block;
            font-family: 'Courier New', monospace;
            font-size: 11pt; /* Font normal agar terbaca jelas */
            font-weight: bold;
            color: #0d47a1;
            background: #e3f2fd;
            padding: 8px 10px;
...
<body>
    ...
    <div class="container-sidebar">
        ...
        @php
            ...
            // Logika baru: Prioritaskan font besar
            $fontClass = 'font-xl'; // Default paling besar
            if ($charLength > 20) {
                $fontClass = 'font-sm';
            } elseif ($charLength > 10) {
                $fontClass = 'font-md';
            } elseif ($charLength > 5) {
                $fontClass = 'font-lg';
            }
    ...
    <div class="container-content">
        ...
        <table class="header-table">
            <tr>
                <td class="header-left-cell">
                    <h2 class="header-title">SERTIFIKASI PROFESI</h2>
        ...
        <div class="footer-section">
            <div class="footer-col-spacer"></div><div class="footer-col-sig">
                <div class="sig-place-date">Kediri, {{ \Carbon\Carbon::parse($lisensi->tgl_terbit)->isoFormat('D MMMM Y') }}</div>
