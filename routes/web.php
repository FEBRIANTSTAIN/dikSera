...
Route::prefix('perawat')->name('perawat.')->group(function () {
    ...
    Route::post('/keluarga/{id}', [PerawatDrhController::class, 'keluargaUpdate'])->name('keluarga.update');
    ...
    Route::post('/organisasi/{id}', [PerawatDrhController::class, 'organisasiUpdate'])->name('organisasi.update');
